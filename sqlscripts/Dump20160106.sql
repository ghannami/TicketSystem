...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `fk_ticket` FOREIGN KEY (`ticket`) REFERENCES `ticket` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `priority` VALUES (1,'normal',5),(2,'wichtig',6),(3,'sehr wichtig',7);
...
INSERT INTO `tickettype` VALUES (1,'Bug'),(2,'Feature');
...
-- Dump completed on 2016-01-06 15:14:19
